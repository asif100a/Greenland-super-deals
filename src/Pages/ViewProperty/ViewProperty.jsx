            ...
            <div className="flex flex-col p-6 lg:flex-row md:max-w-full h-[1330px] md:h-[1200px] lg:h-[676px] text-white">
                ...
                <div className="flex flex-col justify-between lg:ml-6 mt-3 lg:mt-0 leading-normal">
                    <div className="bg-white bg-opacity-25 px-2 rounded-md">
                        <h1 className="mb-2 text-3xl font-bold tracking-tight text-white font-noto_serif">{estate_title}</h1>
                        <p className="mb-3 font-normal text-white font-pt_serif">{description}</p>
                    </div>
                    <div className="py-4 border-t-2 border-b-2 border-dashed mt-6 mb-6">
                        <p className="p-4 border-t border-gray-100 bg-white bg-opacity-30 rounded-lg w-fit shadow-md"><span className="text-xl font-semibold font-noto_serif">{segment_name}</span></p>
                    </div>
