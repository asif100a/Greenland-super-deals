...
import bgImg from '../../assets/corn-garden-blur-background-free-photo.jpg';
    ...
    return (
        <div className="bg-cover bg-center" style={{backgroundImage: `url(${bgImg})`}}>
            <div
                ...
                <div className="flex flex-col justify-center border bg-white bg-opacity-20 rounded-lg mx-auto p-2 md:p-8 py-4 md:py-8 w-[100%] md:w-auto">
